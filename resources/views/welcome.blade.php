    ...
    <main>
        <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <img src="{{ asset('images/principial.jpg') }}" class="bd-placeholder-img" width="100%" height="90%">
...
<center>
        <div class="container marketing">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <img src="{{ asset('images/rostro.jpg') }}" class="bd-placeholder-img rounded-circle" width="200" height="200" alt="Descripción de la imagen">
                        <title>Placeholder</title>
                    </svg>
                    <h2>Reconocimiento</h2>
                    <p>En esta app podras registrarte con un <br>reconocimiento facial efectivo y facil de <br>manejar. </p>
                </div>
                <div class="col-lg-4">
